...
<!--------------------BANNER SPRING OF THE Y--------------------------- -->
    <div id="banner2"><!--banner2 banner rồng -->
        <div class="box-left" >
            <h2>
...
#banner2 .box-left button {/*nút buttom mua ngay*/
    ...
    margin-left:720px;/*chỉnh vị trí buttom trái phải*/
    background:#1d1a1a;
    border:none;
    outline:none;
    color:#fff;
...
#banner3 .box-left button {/*nút buttom mua ngay*/
    ...
    width: 170px;/*chỉnh size dài bóng đen*/
    height: 45px;/*chỉnh size rộng bóng đen*/
    margin-top:550px;/*chỉnh vị trí buttom lên xuống*/
    margin-left:720px;/*chỉnh vị trí buttom trái phải*/
    background:#1d1a1a;
    border:none;
    outline:none;
...
#list-new .box-left{
    ...
    margin-left:-580px;/*chỉnh trái phải nút xem thêm*/
